Truecoin Core version *0.15.1* is now available from:

  <https://download.truecoin.org/truecoin-0.15.1/>
...
A number of changes to the way Truecoin Core deals with peer connections and invalid blocks
