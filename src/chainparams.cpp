...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.truecoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.truecointools.com");
        vSeeds.emplace_back("dnsseed.truecoinpool.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.truecointools.com");
        vSeeds.emplace_back("seed-b.truecoin.loshan.co.uk");
